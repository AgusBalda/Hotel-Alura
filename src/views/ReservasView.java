...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {	
		...
		String valor = txtValor.getText().substring(1);
		System.out.println(valor);
		Reserva nuevaReserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS),Integer.parseInt(valor),txtFormaPago.getSelectedItem().toString());
	...
	private void calcularValor(JDateChooser fechaE,JDateChooser fechaS) {		
		if(fechaE.getDate() != null && fechaS.getDate() !=null) {
	        ...
	        Date fecha1 = inicio.getTime();
	        Date fecha2 = fin.getTime();
			int diaria = 500;
			long valor;
